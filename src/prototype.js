...
function Humanoid(noidOptions) {
  GameObject.call(this, noidOptions);
  NPC.call(this, noidOptions);
  this.faction = noidOptions.faction;
  this.weapons = noidOptions.weapons;
  this.language = noidOptions.language;
}
