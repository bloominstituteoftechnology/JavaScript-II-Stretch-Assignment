...
class User {
  ...
  checkPassword(inputtedPassword) {
    return inputtedPassword === this.password;
  }
}
...
// .call
let passed = checkPassword.call(me, 'correcthorsebatterystaple');
console.log(passed);

// .apply
passed = checkPassword.apply(me, ['correcthorsebatterystaple']);
console.log(passed);

// .bind
const checkPasswordFunction = checkPassword.bind(me, 'correcthorsebatterystaple');

passed = checkPasswordFunction();
console.log(passed);
