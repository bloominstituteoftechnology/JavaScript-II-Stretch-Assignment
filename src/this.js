...
const result = me.checkPassword('correcthorsebatterystaple'); // return true
...
// .bind
const checkedPassword = checkPassword.bind(me);
checkedPassword('correcthorsebatterystaple');
