...
class User {
  ...
  // return `true` if they match, otherwise return `false`
    User.prototype.checkPassword = function checkPassword(inputPass) {
...
const res2 = checkPassword.call(me);
// .call
const res3 = checkPassword.apply(me);
// .apply
const bindPass = checkPassword.bind(me());
// .bind
