...
// .call
const result = checkPassword.call(me, 'correcthorsebatterystaple');

// .apply
const result = checkPassword.apply(me, ['correcthorsebatterystaple']);

// .bind
const result = checkPassword.bind(me)('correcthorsebatterystaple');
