...
const theRightPassword = 'correcthorsebatterystaple';
// invoke `checkPassword` on `me` by explicitly setting the `this` context
// use .call, .apply, and .bind

// .call
checkPassword.call(me, theRightPassword);
// .apply
checkPassword.apply(me, [theRightPassword]);
// .bind
let boundPassword = checkPassword.bind(me);
