...
const i = checkPassword.call(me, 'correcthorsebatterystaple');
console.log(i);
// .call
const e = checkPassword.apply(me, ['correcthorsebatterystaple']);
console.log(e);
// .apply
const t = checkPassword.bind(me);
t('correcthorsebatterystaple');
// .bind
