...
const movies = ['Black Panther', 'Avengers', 'Guardians of the Galaxy'];

function faveMovies(a, b, c) {
  return `'My favorite movies are ' + ${a} + ' ' + ${b} + ' ' + ${c}`;
}

const newFunction = faveMovies.bind(movies, ...movies);
