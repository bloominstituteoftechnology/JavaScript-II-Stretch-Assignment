...
// .call
checkPassword.call(me, 'correcthorsebatterystaple1');
// .apply
checkPassword.apply(me, ['correcthorsebatterystaple2']);
// .bind
const bindChkPwd = checkPassword.bind(me);
bindChkPwd('correcthorsebatterystaple');
