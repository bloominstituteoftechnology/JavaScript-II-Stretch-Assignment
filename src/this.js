...
// Create User & Password properties for the method checkpassword
// Compare one password string to another, return true === if they are same, otherwise return false
