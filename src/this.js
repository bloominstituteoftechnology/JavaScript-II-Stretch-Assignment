...
me.checkPassword.call(this, 'correcthorsebatterystaple');
console.log(result);
// .call
me.checkPassword.apply(this, ['correcthorsebatterystaple']);
console.log(result);
// .apply
me.checkPassword.bind(this)('correcthorsebatterystaple');
console.log(result);
// .bind
