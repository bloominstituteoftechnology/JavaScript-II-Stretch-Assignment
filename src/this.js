...
const checkPassword = function comparePasswords(passwordToCompare) {
  const match = passwordToCompare === this.password;
  return match;// recreate the `checkPassword` method that you made on the `User` class
...
// .bind
const newPassFunc = checkPassword.bind(me);
newPassFunc('correcthorsebatterystaple');
