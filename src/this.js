...
class User {
  ...
  User.prototype.checkPassword = function(potentialPassword){
...
const checkPassword = function comparePasswords(passwordToCompare) {
 ...
 return this.User.password === passwordToCompare;
};

function comparePasswords(me) { return this.password; }
// invoke `checkPassword` on `me` by explicitly setting the `this` context
// use .call, .apply, and .bind

// .call 
comparePasswords.call(me);
// .apply
comparePasswords.apply(me);
// .bind
const boundCheck = comparePasswords.bind(me);