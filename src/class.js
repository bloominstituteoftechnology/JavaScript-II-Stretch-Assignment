...
class User {
  ...
  comparePasswords(potentialPass) {
    if (this.password === potentialPass) return true;
    // the return false is redundant.
    return false;
  }
}
...
class Cat extends Animal {
  constructor(options) {
    // this.name = options.name; refenrce error should call super to access parent class.
    super(options);
