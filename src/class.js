...
class User {
	...
	this.comparePassword = function(checkedPassword){
	  return (this.password === checkedPassword);
	}
  }
}
const myUser = {email: 'a', password: 'ab'}
const user = new User(myUser)
console.log(user.comparePassword('ab')); // true
console.log(user.comparePassword('Ab')); // false
